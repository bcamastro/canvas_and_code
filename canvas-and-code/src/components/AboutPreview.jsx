...
const AboutPreview = () => (
    ...
    <div className="container text-center">
        <h2 className="mb-4">About Canvas & Code</h2>
        <h3 className="mb-4">What we Offer</h3>
        <p>
            Canvas and Code offers everything you need to create the ultimate business branding experience. 
            We pride ourselves on being able to make custom websites unique to you and your business needs. 
            Weather you have been in business for a long time or just starting out we can help you elevate your 
            brand or company.
        </p>
        <h3 className="mb-4">Our Story</h3>
        <p>
            Canvas and Code is founded and run by Brenden Camastro. Since Brenden was a child he loved all things 
            technology and computers. As a teenager he spent many hours on building computers for friends, creating 
        ...
        <a href="#contact" className="btn btn-outline-dark mt-3">Get In Touch</a>
    </div>
    </section>
);
